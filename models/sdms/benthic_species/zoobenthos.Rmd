...
plot_agg <- 1 # Factor by which to decrease plotting resolution
pred_agg <- 10 # Factor by which to decrease predictor resolution
```
...
if(pred_agg > 1){preds <- aggregate(preds, fact = pred_agg, fun = "max")}
