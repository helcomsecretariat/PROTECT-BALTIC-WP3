...
#preds <- aggregate(preds, fact = 4, fun = "mean")
...
temp <- aggregate(temp, fact = 5, fun = "max") # Decrease resolution for plotting
...
temp <- aggregate(temp, fact = 5, fun = "median") # Decrease resolution for plotting
plet(temp, tiles=c("Esri.WorldImagery"), maxcell=ncell(temp))
```
