...
temp <- project(temp, grid, method = "near")
temp <- temp*grid
#writeRaster(temp, "outputs/o2_surface_sd_250m.tif", overwrite = TRUE, # Use to export non-resampled layer
#            datatype = "FLT4S", gdal=c("COMPRESS=ZSTD", "PREDICTOR=2"))
...
temp <- project(temp, grid, method = "near")
temp <- temp*grid
#writeRaster(temp, "outputs/o2_bottom_sd_250m.tif", overwrite = TRUE, # Use to export non-resampled layer
#            datatype = "FLT4S", gdal=c("COMPRESS=ZSTD", "PREDICTOR=2"))
