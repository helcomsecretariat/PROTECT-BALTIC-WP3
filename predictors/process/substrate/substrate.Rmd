...
#writeRaster(sub, "outputs/biozone_250m.tif", overwrite = TRUE) # Use to export non-resampled layer
...
bio_res <- resint(bio, grid, nit = 50, win_size = 3, method = "cubic")
...
#writeRaster(sub, "outputs/sediment_250m.tif", overwrite = TRUE) # Use to export non-resampled layer
